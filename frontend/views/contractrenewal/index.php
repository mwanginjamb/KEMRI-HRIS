...
$this->params['breadcrumbs'][] = ['label' => 'Contract Renewal List', 'url' => ['index']];
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
        <?= \yii\helpers\Html::a('New Contract Renewal',['create'],['class' => 'btn btn-info push-right', 'data' => [
    ...
    <div class="col-md-12">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Contract Renewal List</h3>
    ...
    $(function(){
        ...
        const url = $('#url').val();
          ...
          $('#table').DataTable({
           ...
           language: {
                "zeroRecords": "No Contracts Renewals to display"
            },
